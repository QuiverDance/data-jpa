...
public interface MemberRepository extends JpaRepository<Member, Long>, MemberRepositoryCustom, JpaSpecificationExecutor {
    ...
    countQuery = "select count(m) from Member m") //count query 최적화
    Page<Member> findByMemberWithTeam(int age, Pageable pageable);
    ...
    <T> List<T> findClassProjectionByUsername(@Param("username") String username, Class<T> type);
